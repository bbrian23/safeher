      ...
      alert.innerHTML = `
        <div style="display: flex; align-items: flex-start; gap: 16px;">
          ...
          <div style="flex: 1;">
            ...
            <button class="safespace-view-alerts" style="width: 100%; padding: 10px 14px; background: rgba(255, 255, 255, 0.25); color: white; border: 1px solid rgba(255, 255, 255, 0.4); border-radius: 6px; font-weight: 600; cursor: pointer; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px; transition: all 0.2s; margin-top: 8px;">
